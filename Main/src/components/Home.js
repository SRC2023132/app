...
const Home = () => {
  return (
    <div className="home">
      <header>
        <h1 className="welcome-heading">Welcome to MP</h1>
        <p>Your Path to Success Begins Here</p>
      </header>
      <section className="about">
        <h2>About Us</h2>
      <p >&nbsp;Our Educational Trust is a registered non-minority service organization established in the year 1986 by Thiru. M.V. Muthuramalingam to inculcate among the youth a sense of discipline which is important to mould them into useful and capable citizens. The watch words of the Trust are “Dedication, Determination and Distinction”.
      Our was established in the year 1995-96 to impart quality education. It is a self financing non-minority institution, affiliated to Anna University and approved by All India Council for Technical Education (AICTE) and also an ISO certified institution.</p>
        <p>
